export default function WorkbookInfoModal() {
  return (
    <div className="fixed bg-black bg-opacity-30 top-0 left-0 w-screen h-screen px-[470px] py-[250px] z-[11]">
      <div className="relative flex flex-col w-full h-full bg-white rounded-[24px] gap-[30px]">
        ...
        <div className="flex justify-center ">
          <div className="px-[20px] border-r">김땡땡</div>
          <div className="px-[20px] border-r">24-02-18</div>
          <div className="px-[20px]">10문제</div>
        </div>
        <div>
          <img />
          <button></button>
